import { encodeBase62, decodeBase62, generateShortCode, URLShortener } from "./urlshortener";
...
export function runCheck(): boolean {
  ...
  const encodeTests: TestCase<number, string>[] = [
  ...
  const decodeTests: TestCase<string, number>[] = [
    { input: "0", expect: 0, name: "Zero" },
    { input: "9", expect: 9, name: "Single digit" },
